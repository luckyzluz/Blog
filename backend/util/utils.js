 ...
 */
var DateSort = function (data, p, sort) {
...
var compare = function (property) {
 ...
 var DateSortx = function (data, p, sort) {
    data.sort(compare(p));
}
/**
 * 文件大小转换
 ...
 */
const ifExist = function (filePath) {
...
const ifFileName = function (filePath, fname, index) {
 ...
 * @result {} 返回缺失数字数组
 */
var checkSeriesNum = function (arr, start = 0, end) {
 ...
 * @param {*} nTimeStamps 
 */
var getTimeInfo = function (nTimeStamps) {
    //转毫秒
...
var removeByVal=function (arrylist , val) {
...
module.exports = { DateSort, formatBytes, delay, createFolder, ifExist, ifFileName, checkSeriesNum, getNowSceond, getTimeInfo ,DateSortx,createSixNum,removeByVal}