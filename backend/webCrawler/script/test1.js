/**
 * 获取 燃文网站 https://www.ranwen.tv/book/2086/ 小说
 * 下载为txt文件
 */
{
    // 单行进度打印
    ...
    const mrlyConfig = {
      name: '末日乐园',
      txtFileName: '末日乐园.txt',
      indexUrl: 'https://www.ranwen.tv/book/2086/',
      chapterUrlPrefix: 'https://www.ranwen.tv/book/2086/',
      novelInfoCls: '#box-info #info',
      linkCls: '.book_list ul.chapterlist:last-child li:not(.volume) a',
      adCls: ['.google-auto-placed', '#p_ad_t3', '#content>p:last-child'],
      titleCls: '#content .wrapper_main h1.h1title',
      contentCls: 'div#htmlContent',
    ...
    start(bqgConfig.config, mrlyConfig);
  }
//   node webCrawler\script\test1.js